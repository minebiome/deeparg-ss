def normalize(fi16s, fiArg, covi, parameters={}):
    ...
    # print N16s
    fo1 = open("normailize/"+fiArg+'.subtype', 'w')
    ...
    fo2 = open("normailize/"+fiArg+'.type', 'w')
...
normalize("test/reads.clean.sorted.bam.merged.quant","test/reads.clean.deeparg.mapping.ARG.merged.quant",0.01)